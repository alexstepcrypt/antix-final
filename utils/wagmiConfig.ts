...
if (typeof window !== 'undefined' && isMobile() && !window.ethereum) {
	customWallets.push({
		...
		desktop_link: null,
		// mobile_link: 'https://metamask.app.link/dapp/'+location.host+'\\/dashboard/'+location.search
		// mobile_link: 'metamask://wc?uri='+location.host+'/dashboard/'+location.search
		mobile_link: 'dapp://'+location.host+'/dashboard/'+location.search
	})
}
