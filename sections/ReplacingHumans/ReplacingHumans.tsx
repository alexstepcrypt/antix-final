...
const ReplacingHumans = () => {
    ...
    const leftList = t('replacingHumans.leftList', { returnObjects: true }) as Array<dropDownItemType>;
    const rightList = t('replacingHumans.rightList', { returnObjects: true }) as Array<dropDownItemType>;
